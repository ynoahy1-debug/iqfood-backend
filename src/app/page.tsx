...
export default async function DashboardOverviewPage() {
 ...
 <span style={{ color:'#38bdf8', fontSize: 12 }}>عرض دليل المطاعم </span>
 </div>
 </Link>
 ...
 <span style={{ color:'#a855f7', fontSize: 12 }}>إدارة المستخدمين والكبار </span>
 </div>
 </Link>
 ...
 <span style={{ color:'#eab308', fontSize: 12 }}>مراجعة المنشورات المعلقة </span>
 </div>
 </Link>
 ...
 <span style={{ color:'#ff4757', fontSize: 12 }}>إدارة الحدود والاشتراكات </span>
 </div>
 </Link>
 </div>
